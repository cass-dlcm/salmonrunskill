...
// Part of "github.com/zelenin/go-glicko2". In this file, the original AddMatch function was duplicated, with
// AddMatch2Player being the original, and AddMatch1Player being a modified version.
...
func (period *RatingPeriod) AddMatch1Player(player1 *Player, player2 *Player, score MatchResult) {
	...
	// This line, player2.addMatch(match), was removed.
}
